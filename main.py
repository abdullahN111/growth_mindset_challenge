...
st.markdown('<div class="custom-text">A fun, brain-teasing word game for techies! Guess programming languages, frameworks, and coding terms before time runs out. Stuck? Maybe its a feature, not a bug! 🔥💻 Think fast, code faster, and debug your way to victory! 🚀</div>', unsafe_allow_html=True)
